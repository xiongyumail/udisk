...
-- local ram_file = ramf.malloc(20 * 1024)
...
-- print(web.file(ram_file, 'http://xwx.emake.run/udisk/pic/love1.png'))
-- lcd.write('IMG', ram_file)
print(web.file('/lua/png/love3.bin', 'http://xwx.emake.run/udisk/pic/love3.bin'))
sys.yield()
lcd.write('IMG', 'P:/lua/png/love3.bin')
lcd.print('')
-- while (1) do
...
--         if (shares) then
--             web.file(ram_file, 'http://xwx.emake.run/udisk/pic/love1.png')
--             lcd.write('IMG', ram_file)
