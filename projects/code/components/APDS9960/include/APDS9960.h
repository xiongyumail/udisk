 ...
 *     - ESP_FAIL Fail
 */
esp_err_t apds9960_write_byte(apds9960_handle_t sensor, uint8_t reg_addr,
        uint8_t data);
 ...
 *     - ESP_FAIL Fail
 */
esp_err_t apds9960_read_byte(apds9960_handle_t sensor, uint8_t reg_addr, uint8_t *data);
 ...
 *     - Others Success
 */
apds9960_handle_t apds9960_create(i2c_port_t bus,
        uint16_t dev_addr);
